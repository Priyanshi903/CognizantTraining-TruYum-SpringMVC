							...
							<tbody>
								<c:forEach items="${menuItemList}" var="menuItem">
									<tr>
										...
										<td style="text-align: center">Rs. <fmt:formatNumber minFractionDigits="2" value="${menuItem.price}"
												type="number" /></td>
										<td style="text-align: center">${menuItem.active}</td>
										<td style="text-align: center"><fmt:formatDate value="${menuItem.dateOfLaunch}" type="date"
